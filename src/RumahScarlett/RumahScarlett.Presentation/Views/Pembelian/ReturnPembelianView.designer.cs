...
{
   partial class ReturnPembelianView
   {
      /// <summary>
      ...
      private void InitializeComponent()
      {
         ...
         this.labelSubTotalPembelian.Text = "-";
         // 
         // labelDiskonPembelian
         // 
         ...
         this.labelDiskonPembelian.Text = "-";
         // 
         // labelTotalPembelian
         // 
         ...
         this.Name = "ReturnPembelianView";
         this.Text = "Return Pembelian";
         this.Load += new System.EventHandler(this.ReturnPembelianView_Load);
