...
{
   partial class LaporanReturnPembelianView
   {
      /// <summary>
      ...
      private void InitializeComponent()
      {
         ...
         this.Name = "LaporanReturnPembelianView";
         this.Text = "Laporan Return Pembelian";
         this.Load += new System.EventHandler(this.LaporanReturnPembelianView_Load);
