namespace RumahScarlett.Presentation.Views.GantiPassword
{
   partial class GantiPasswordView
   {
      ...
      private void InitializeComponent()
      {
         ...
         this.textBoxPasswordSekarang = new RumahScarlett.Presentation.Views.CommonControls.BaseTextBox();
         this.textBoxPasswordBaru = new RumahScarlett.Presentation.Views.CommonControls.BaseTextBox();
         this.textBoxKonfPasswordBaru = new RumahScarlett.Presentation.Views.CommonControls.BaseTextBox();
