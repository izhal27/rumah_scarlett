namespace RumahScarlett.Presentation.Views.Login
{
   partial class LoginView
   {
      ...
      private void InitializeComponent()
      {
         ...
         this.textBoxPasswordDatabase = new RumahScarlett.Presentation.Views.CommonControls.BaseTextBox();
         this.textBoxUser = new RumahScarlett.Presentation.Views.CommonControls.BaseTextBox();
         this.textBoxPort = new RumahScarlett.Presentation.Views.CommonControls.BaseTextBox();
         ...
         this.tableLayoutPanel3.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle());
         this.tableLayoutPanel3.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle());
         this.tableLayoutPanel3.Controls.Add(this.buttonTesKoneksi, 3, 3);
