...
{
   partial class PenyesuaianStokView
   {
      /// <summary>
      ...
      private void InitializeComponent()
      {
         ...
         this.label1.Text = "Total HPP";
         // 
         // labelTotalHpp
         // 
         this.labelTotalHpp.Anchor = System.Windows.Forms.AnchorStyles.Right;
         this.labelTotalHpp.AutoSize = true;
         this.labelTotalHpp.Location = new System.Drawing.Point(192, 38);
         this.labelTotalHpp.Name = "labelTotalHpp";
         this.labelTotalHpp.Size = new System.Drawing.Size(13, 13);
         this.labelTotalHpp.TabIndex = 1;
         this.labelTotalHpp.Text = "0";
         // 
         // label5
         // 
         ...
         this.label8.Location = new System.Drawing.Point(67, 8);
         ...
         this.tableLayoutPanel1.Controls.Add(this.labelTotalHpp, 2, 1);
         this.tableLayoutPanel1.Controls.Add(this.label5, 0, 0);
         this.tableLayoutPanel1.Controls.Add(this.labelTotalQty, 2, 0);
         ...
         this.tableLayoutPanel1.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 25F));
         this.tableLayoutPanel1.Size = new System.Drawing.Size(208, 60);
         ...
         this.Name = "PenyesuaianStokView";
         this.Text = "Penyesuaian Stok";
         this.Load += new System.EventHandler(this.PenyesuaianStokView_Load);
