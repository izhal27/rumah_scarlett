...
namespace RumahScarlett.Services.UnitTests.Laporan
{
   ...
   public class StatusBarangServicesDataAccessTests
   {
      private IStatusBarangServices _services;
      private ITestOutputHelper _testOutputHelper;

      public StatusBarangServicesDataAccessTests(ITestOutputHelper testOutupuHelper)
      {
      ...
      {
         IStatusBarangModel model = null;

         try
         {
            model = _services.GetByDate(DateTime.Now.Date);
         }
